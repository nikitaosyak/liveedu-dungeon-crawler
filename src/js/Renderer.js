...
export const Renderer = () => {
    ...
    Object.keys(RENDER_LAYER).forEach(layer => {
        ...
        viewport.addChild(layers[layer])
    })
    ...
    const self =  {
        ...
        addViewport: vp => {
            layers[RENDER_LAYER.CHARACTERS].addChild(vp)
        },
        addObject: (go) => {
        ...
        removeObject: go => {
            ...
            if (parent) {
                ...
                viewport.removeChild(go.visual)
            }
        },
        update: dt => {
